...
<div id='container'>
  ...
  <option value="What is the name of your fiest pet?">What is the name of your first pet?</option>
  <option value="What elementry school you are attented?">What elementry school you are attented?</option>
  <option value="What is name of the town where you are born? ">What is name of the town where you are born?</option>
  </select>
