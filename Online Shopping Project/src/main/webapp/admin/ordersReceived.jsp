...
%>
	...
	<h3 class="alert">Order Deliverd Successfully!</h3>
	<%} %>
	...
	<table id="customers">
       ...
       %>
		<tr>
			...
			<td><a
				href="cancleOderAction.jsp?id=<%=rs.getString(2)%>&email=<%=rs.getString(1)%>">Cancel
					<i class='fas fa-window-close'></i>
			</a></td>
			<td><a
				href="deliveredOrderAction.jsp?id=<%=rs.getString(2)%>&email=<%=rs.getString(1)%>">Delivered
